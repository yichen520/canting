/* zepto.js 寮€濮� Zepto v1.0-1-ga3cab6c - polyfill zepto detect event ajax form fx - zeptojs.com/license */
...
$(function() {
	...
	$(".plug-menu").on('touchmove', function(event) {
